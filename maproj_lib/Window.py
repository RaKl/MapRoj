...
# This class is meant to be subclassed by MaprojWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseMaprojWindow object.
        """
        builder = get_builder('MaprojWindow')
        new_object = builder.get_object("maproj_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a MaprojWindow object with it in order to finish
        initializing the start of the new MaprojWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.maproj")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('maproj')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for maproj."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for maproj."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the MaprojWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the MaprojWindow is closed."""
